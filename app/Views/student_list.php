...
<header>
    ...
    <div class="heroe">
      ...
      <form action="<?php echo site_url('teacher_timetable/');?>" method="POST" id="teacher_classes_form">
        <input type="hidden" id="teacher_id" name="teacher_id" value="<?php echo htmlspecialchars($teacher_id);?>"/>
        <input type="hidden" id="teacher_mis_id" name="teacher_mis_id" value="<?php echo htmlspecialchars($teacher_mis_id);?>"/>
        <input class="btn btn-primary" type="submit" value="Back to lesson list">
      </form>
    </div>
    ...
    <table class="table table-bordered table-condensed table-striped table-hover">
      ...
      <tbody>
        <?php foreach ($students as $student): ?>
          <tr data-toggle="modal" data-target="#student_modal" class='table-row' data-student_id=<?php echo htmlspecialchars($student->id);?> data-class_mis_id=<?php echo htmlspecialchars($student->mis_id);?>>
