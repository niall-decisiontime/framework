...
<header>
    ...
    <div class="heroe">
      ...
      <a class="btn btn-primary" href="<?php echo site_url('/');?>" role="button">Back to teacher list</a>
    </div>
...
<section>
    <h3>Please select a lesson, to see what students are in the class:</h3>
    <table class="table table-bordered table-condensed table-striped table-hover">
      ...
      <?php foreach ($lessons as $lesson): ?>
          <tr class='table-row' data-class_id=<?php echo htmlspecialchars($lesson->class_id);?> data-class_mis_id=<?php echo htmlspecialchars($lesson->class_mis_id);?>>
            <td><?php echo htmlspecialchars($lesson->class_name);?></td>
      ...
      <form style="display: none" action="<?php echo site_url('students_in_class/');?>" method="POST" id="students_in_class_form">
        <input type="hidden" id="teacher_id" name="teacher_id" value="<?php echo htmlspecialchars($teacher->id);?>"/>
        <input type="hidden" id="teacher_id" name="teacher_mis_id" value="<?php echo htmlspecialchars($teacher->mis_id);?>"/>
